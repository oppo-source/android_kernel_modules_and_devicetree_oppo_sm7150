...
#define SHUTDOWN_DEFAULT_TOTAL_TIME_6125    150
...
static ssize_t shutdown_detect_trigger(struct file *filp, const char *ubuf, size_t cnt, loff_t *data)
{
    ...
    if(is_project(OPPO_19021) || is_project(OPPO_19022) || is_project(OPPO_19028) || is_project(OPPO_19029) || is_project(OPPO_19340)
          || is_project(OPPO_19341) || is_project(OPPO_19342) || is_project(OPPO_19325) || is_project(OPPO_19326) || is_project(OPPO_19327)
           ...
           || is_project(OPPO_19576) || is_project(OPPO_19577) || is_project(OPPO_19578) || is_project(OPPO_19579) || is_project(OPPO_19171)
            || is_project(OPPO_19175) || is_project(OPPO_19176) || is_project(OPPO_19375) || is_project(OPPO_19376) )
        temp = SHUTDOWN_DEFAULT_TOTAL_TIME_6125;
    else
        temp = SHUTDOWN_DEFAULT_TOTAL_TIME;
...
static int shutdown_detect_func(void *dummy)
{
    ...
    if(is_project(OPPO_19021) || is_project(OPPO_19022) || is_project(OPPO_19028) || is_project(OPPO_19029) || is_project(OPPO_19340)
          || is_project(OPPO_19341) || is_project(OPPO_19342) || is_project(OPPO_19325) || is_project(OPPO_19326) || is_project(OPPO_19327)
           ...
           || is_project(OPPO_19576) || is_project(OPPO_19577) || is_project(OPPO_19578) || is_project(OPPO_19579) || is_project(OPPO_19171)
            || is_project(OPPO_19175) || is_project(OPPO_19176) || is_project(OPPO_19375) || is_project(OPPO_19376) ) {
        gtotaltimeout = SHUTDOWN_DEFAULT_TOTAL_TIME_6125;
    }
